...
if __name__ == "__main__":
    ...
    draw_img_save = "./output/inference_results/test_sheets/angle/"
    ...
    logger.info("Angle predict total time cost: {:.2f}s".format(elapse))
    logger.info("Angle predict time cost per an image: {:.2f}s".format(elapse/total))
    print(targets)
